package ua.zotin.java.testtask.entities;
...
public class User {
    ...
    max = ApplicationConstants.DataValidation.MAX_SIZE_FIRST_NAME, message = "Size of first name must be between 2 and 50 characters")
    @Column(name = "first_name")
    @NotBlank(message = "First name cannot be empty")
    private String firstName;

    @Size(min = ApplicationConstants.DataValidation.MIN_SIZE_LAST_NAME,
    max = ApplicationConstants.DataValidation.MAX_SIZE_LAST_NAME, message = "Size of last name must be between 2 and 50 characters")
